<?php
    ...
    if(!empty($_POST['nom']) && !empty($_POST['prenom'])&& !empty($_POST['fonction'])&& !empty($_POST['adresse'])&& !empty($_POST['email'])&& !empty($_POST['adresse'])&& $_POST['mdp']){
        ...
        try{
            ...
            $req = "UPDATE utilisateur ( idUtilisateur ,nomUtilisateur, prenomUtilisateur, adresseUtilisateur, fonctionUtilisateur, typeUtilisateur,emailUtilisateur, password) VALUES (NULL,'".$_POST["nom"]."','".$_POST["prenom"]."','".$_POST["adresse"]."','".$_POST["fonction"]."','".$_POST["typeUtilisateur"]."','".$_POST["email"]."','".$_POST['mdp']."') WHERE = idUtilisateur = $_SESSION['idUtilisateurConnected'];";
